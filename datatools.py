...
if __name__ == '__main__':
    ...
    wait = input('1 : .RData single column trans to single line file(ldpred2 auto output)\n\
        2:  (ldpred2 grid/ngrid and inf output for ibd&af diseases)\n')
    if wait == '1':  
        trans_queue1 = ['gw_train_cad','gw_train_ibd','gw_train_bc','gw_train_af','gw_train_t2d']
        for i in trans_queue1:
            Rdata2text( i , 'pred_train' , '.score' ,main_path+"/data/results/ldpred2/")
        trans_queue2 = ['gw_test_cad','gw_test_ibd','gw_test_bc','gw_test_af','gw_test_t2d']
        for i in trans_queue2:
            Rdata2text( i , 'pred_test' , '.score' ,main_path+"/data/results/ldpred2/")
        trans_queue3 = ['gw_vali_cad','gw_vali_ibd','gw_vali_bc','gw_vali_af','gw_vali_t2d']
        for i in trans_queue3:
            Rdata2text( i , 'pred_val' , '.score' ,main_path+"/data/results/ldpred2/")
    if wait == '2':
        trans_queue1 = ['gw_train_ibd_inf','gw_train_af_inf','gw_train_ibd_grid','gw_train_af_grid','gw_train_ibd_gridn','gw_train_af_gridn']
        for i in trans_queue1:
            Rdata2text( i , 'pred_train' , '.score' ,main_path+"/data/results/ldpred2/")
        trans_queue2 = ['gw_test_ibd_inf','gw_test_af_inf','gw_test_ibd_grid','gw_test_af_grid','gw_test_ibd_gridn','gw_test_af_gridn']         
        for i in trans_queue2:
            Rdata2text( i , 'pred_test' , '.score' ,main_path+"/data/results/ldpred2/")
        trans_queue3 = ['gw_vali_ibd_inf','gw_vali_af_inf','gw_vali_ibd_grid','gw_vali_af_grid','gw_vali_ibd_gridn','gw_vali_af_gridn']
        for i in trans_queue3:
            Rdata2text( i , 'pred_val' , '.score' ,main_path+"/data/results/ldpred2/")
