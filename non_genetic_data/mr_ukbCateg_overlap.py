...
selected = pd.read_table(os.path.join(path,'field_name_pval.txt'),header=None).values[:,0]
ukb_info_mat = pd.read_table('processed_706_Physical_measures.txt')  # processed_706_Physical_measures, processed_704_Lifestyle
