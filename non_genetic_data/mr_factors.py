...
df_2 = pd.read_csv(os.path.join(path, 'features_selection', 'features_selection_info.csv'),header=None).iloc[:,:3]
...
selected = df.iloc[:30,:] # ranking the factors by q-values in descent and selecting top-30 
